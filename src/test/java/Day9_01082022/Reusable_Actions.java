...
public class Reusable_Actions {
    ...
    public static void scrollMethod(WebDriver driver, String x, String y, String scroll){
        ...
        try {
            ...
            System.out.println("Unable to scroll " + scroll + " Error:" + e);
        }
    }
    ...
    public static void selectMethode(WebDriver driver, String xpath, String userData, String elementName){
        //declare local explicit wait
        WebDriverWait wait = new WebDriverWait(driver,15);
